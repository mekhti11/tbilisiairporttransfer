...
?>
    ...
    <div class="box">
      ...
      <input type="text" placeholder="Reservation Number" id="rezervationnum" name="uname" required><br>

      <button type="submit" class="btn primary-btn loginbtn" id="rezervationnum" style="margin-left : 250px;width : 50%;" > SEARCH </button>
    </div>
